# NemoClaw-101: 전문가 에이전트 실전 운영 입문
...
| 차시 | 주제 | 핵심 내용 | 상세 링크 |
| :--- | :--- | :--- | :--- |
| **1차시** | NemoClaw 이해 | 개념 이해, OpenClaw와의 차이, 실사용 관점 | [바로가기](./1차시.md) |
| **2차시** | 운영 구조 및 샌드박스 | OpenShell sandbox, 정책, 네트워크 통제 | [바로가기](./2차시.md) |
| **3차시** | 실전 워크플로우 설계 | 개인/창업/전문가 에이전트 시나리오 | [바로가기](./3차시.md) |
| **4차시** | 안전한 자동화 및 체계 | 보안 원칙, 승인형 자동화, 운영 정책 수립 | [바로가기](./4차시.md) |
